...
public class Deck {
    ...
    public Deck() {
        ...
        Shape [] allShapes ={new Shape(new Bloc()),//1
                             ...
                             new Shape(new Bloc(0,2),new Bloc(0,3),new Bloc(1,0),new Bloc(1,1),new Bloc(1,2)),//12
                             new Shape(new Bloc(0,1),new Bloc(0,2),new Bloc(1,0),new Bloc(1,1),new Bloc(1,2)),//13
                             new Shape(new Bloc(),new Bloc(1,0),new Bloc(1,1),new Bloc(0,2),new Bloc(1,2)),//14
                             new Shape(new Bloc(),new Bloc(0,1),new Bloc(1,1),new Bloc(0,2),new Bloc(0,3)),//15
                             new Shape(new Bloc(0,2),new Bloc(1,0),new Bloc(1,1),new Bloc(1,2),new Bloc(2,2)),//16
                             ...
                             new Shape(new Bloc(1,0),new Bloc(0,1),new Bloc(1,1),new Bloc(1,2),new Bloc(2,1))//21
                            };
